...
<template>
  <div v-if="bangumi" class="max-w-6xl mx-auto px-4 py-10">
    <!-- 顯示收藏按鈕的番劇橫幅 -->
    <div class="relative mb-8">
      <div class="h-48 w-full bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl"></div>
      <div class="absolute inset-0 flex items-center px-8">
        <div class="flex items-center">
          ...
          >
          <div class="ml-6">
            <h1 class="text-4xl font-bold text-white mb-2">{{ bangumi.title }}</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="md:col-span-2">
        ...
        <div v-if="activeTab === 'information'" class="space-y-6">
          <div>
            <h2 class="text-xl font-bold mb-3">故事介紹</h2>
            <p class="text-stone-700 leading-relaxed">{{ bangumi.description }}</p>
          </div>
          
          <div>
            <h2 class="text-xl font-bold mb-3">製作人員</h2>
            <div class="grid grid-cols-2 gap-y-2">
              <div class="text-stone-600">原作</div>
              <div>範例工作室</div>
              <div class="text-stone-600">導演</div>
              <div>島田一郎</div>
              <div class="text-stone-600">腳本</div>
              <div>田中美穗</div>
              <div class="text-stone-600">人物設定</div>
              <div>佐藤健太</div>
              <div class="text-stone-600">音樂</div>
              <div>山本直樹</div>
            </div>
          </div>
          
          <div>
            <h2 class="text-xl font-bold mb-3">聲優陣容</h2>
            <div class="grid grid-cols-2 gap-y-2">
              <div class="text-stone-600">主角</div>
              <div>花澤香菜</div>
              <div class="text-stone-600">女主角</div>
              <div>早見沙織</div>
              <div class="text-stone-600">配角 A</div>
              <div>內山昂輝</div>
              <div class="text-stone-600">配角 B</div>
              <div>小野賢章</div>
            </div>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'episodes'">
          <h2 class="text-xl font-bold mb-4">全部劇集</h2>
          <div class="space-y-3">
            <div 
            ...
            >
              ...
              <div class="ml-3 flex-1">
                <div class="font-medium">第{{ episode.number }}集：{{ episode.title }}</div>
        ...
        <div v-if="activeTab === 'comments'">
          <h2 class="text-xl font-bold mb-4">用戶評論</h2>
          ...
          <div class="mb-6">
            ...
            <div class="flex justify-between items-center mt-2">
              <div class="text-stone-500 text-sm">評分：
                <div class="inline-flex">
                  <span v-for="i in 5" :key="i" class="cursor-pointer">⭐</span>
                </div>
              </div>
            ...
            <div class="border-b last:border-b-0 pb-4">
              <div class="flex items-start">
                ...
                <div class="ml-3 flex-1">
                  ...
                  <p class="mt-1 text-stone-800">這部作品的劇情和角色設定非常出色，每集都能給人驚喜。強烈推薦！</p>
                </div>
              </div>
            </div>
            ...
            <div class="border-b last:border-b-0 pb-4">
              <div class="flex items-start">
                ...
                <div class="ml-3 flex-1">
                  ...
                  <p class="mt-1 text-stone-800">畫風很不錯，但是節奏有點慢。總體來說值得一看！</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 border">
          <h3 class="font-medium mb-3">作品信息</h3>
        ...
        <!-- 相關推薦 -->
        <div>
          <h3 class="font-medium mb-3">相關推薦</h3>
          <div class="space-y-3">
            <RouterLink
            ...
            >
              ...
              <div class="ml-3">
                ...
                <div class="text-xs text-stone-500 mt-1">{{ item.airDate }}</div>
              </div>
            </RouterLink>
          </div>
        </div>
